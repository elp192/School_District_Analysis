...
Hint: The above conclusion is for when the number of students who get NAN score (9th graders) are considered in the calculation of total number of students in Thomas High School (See [Performance of schools 1](https://github.com/elp192/School_District_Analysis/blob/e056e8e4a3df4e63392aea0169865ed4a0de074c/Results/performance1_after_data_modification.png)); however, if the 9th grade studetns are eliminated from the calculation, the results are changed ([See Performance of schools 2](https://github.com/elp192/School_District_Analysis/blob/e056e8e4a3df4e63392aea0169865ed4a0de074c/Results/performance2_after_data_modification.png)). See this [table](https://github.com/elp192/School_District_Analysis/blob/e056e8e4a3df4e63392aea0169865ed4a0de074c/Results/Performance_before_data_modification.png) for comapring these results with performance of schools before dataset modification.
